...
Updater.prototype.printUpdated = function(cb) {
  ...
  // var updated = { cities: 0, countries: 0 }
  //
  // updated.cities = records.records.cities.total - records.records.cities.failed
  // updated.countries = records.records.countries - records.records.countries.failed
