...
function message (err) {
  ...
  switch (err.code) {
    ...
    case 'EMONGOCONREF':
      short.push(['mongoimport', err.message])
      ...
      detail.push([
        ...
        [
          ...
          'In most cases you have supplied an invalid uri or have bad network settings.',
          '',
          `host: ${err.host}`
        ].join('\n')
      ])
    ...
    case 'EMONGO':
      ...
      detail.push([
        ...
        [
          '',
          'This is an error related to mongoimport, or our usage',
          'please create an issue on github with the full error log',
    ...
    case 'ETOOMANYARGS':
      ...
      detail.push([
        ...
        [
          '',
          'This is an error with geo itself. Please report this error to:',
          '    <harryw@resdev.com>'
        ].join('\n')
      ])
      break
